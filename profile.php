        ...
        <header id="header">
                <div id="form_main">
                    ...
                    if(!isset($id)){                      
                        ...
                        $user->ViewUserProfileOnId($id,$login);  
                    }
                    ?>
                </div>
        </header>
        ...
        <main>        
                    <div id="top_menu">
                        <?php                                     
                            ...
                            echo 'Авторизуйтесь для возможности редактирования учебника!';
                              ...
                              $menu->ViewMainMenuSel($st_id,$dbmenutable);  
                            }
                        ?>
                    </div>
                        ...
                        <?php
                           $content= new TContentSite;
                            ...
                            $menu->ViewPodmenuSel(1);
                                ...
                                //$menu->ViewPodmenuSel($st_id);
                                $menu->ViewPodmenuProfileSel($st_id); 
                            }                        
                        ?>
                    </div>
                    ...
                    <div id="content">
                        <?php  
                            ...
                            $myadm_content->UserProfile_PageContent($st_id);
